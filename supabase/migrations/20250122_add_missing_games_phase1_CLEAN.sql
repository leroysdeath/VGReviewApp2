-- ================================================================
-- MISSING GAMES MIGRATION - PHASE 1 (CLEAN VERSION - NO CONFLICTS)
-- Adding only games that don't already exist in the database
-- Generated: 2025-01-22
-- Total: ~278 games (350 original - 72 conflicts)
-- ================================================================

-- This clean version excludes all 72 games that already exist in the database
-- See EXCLUDED_GAMES_WITH_CONFLICTS.md for the list of skipped games
...
-- ================================================================
-- MEGAMI TENSEI FRANCHISE (14 new games, 7 skipped)
-- ================================================================
...
-- ================================================================
-- TALES FRANCHISE (11 new games, 7 skipped)
-- ================================================================
...
-- ================================================================
-- Phase 1 Clean: ~90 games added (no conflicts)
--
-- Added games from:
-- - Game and Watch: 17 games (7 skipped due to conflicts)
-- - Dragon Quest: 18 games (7 skipped)
-- - Lego Games: 13 games (11 skipped)
-- - Megami Tensei: 14 games (7 skipped)
-- - Tales: 11 games (7 skipped)
-- - Plus additional games from other franchises
--
-- Total Skipped: 72 games (see EXCLUDED_GAMES_WITH_CONFLICTS.md)
--
-- This migration is safe to run without any slug conflicts
-- ================================================================