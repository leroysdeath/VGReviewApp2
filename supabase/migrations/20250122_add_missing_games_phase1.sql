-- ================================================================
-- MISSING GAMES MIGRATION - PHASE 1
...
VALUES
-- Silver Series (1980)
('gw_ball_1980', 'Game & Watch: Ball', 'game-and-watch-ball', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1980-04-28', 'Nintendo R&D1', 'Nintendo', NOW()),
('gw_flagman_1980', 'Game & Watch: Flagman', 'game-and-watch-flagman', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1980-06-05', 'Nintendo R&D1', 'Nintendo', NOW()),
('gw_vermin_1980', 'Game & Watch: Vermin', 'game-and-watch-vermin', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1980-07-10', 'Nintendo R&D1', 'Nintendo', NOW()),
...
('gw_judge_1980', 'Game & Watch: Judge', 'game-and-watch-judge', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1980-10-04', 'Nintendo R&D1', 'Nintendo', NOW()),

-- Gold Series (1981)
('gw_manhole_1981', 'Game & Watch: Manhole', 'game-and-watch-manhole', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1981-01-29', 'Nintendo R&D1', 'Nintendo', NOW()),
('gw_helmet_1981', 'Game & Watch: Helmet', 'game-and-watch-helmet', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1981-02-21', 'Nintendo R&D1', 'Nintendo', NOW()),
...
('gw_chef_1981', 'Game & Watch: Chef', 'game-and-watch-chef', 'Game and Watch', ARRAY['Game & Watch'], 'manual', true, '1981-09-08', 'Nintendo R&D1', 'Nintendo', NOW()),
...
('dq_monsters_caravan', 'Dragon Quest Monsters: Caravan Heart', 'dragon-quest-monsters-caravan-heart', 'Dragon Quest', ARRAY['Game Boy Advance'], 'manual', true, '2003-03-29', 'TOSE', 'Enix', NOW()),
('dq_monsters_joker2_pro', 'Dragon Quest Monsters: Joker 2 Professional', 'dragon-quest-monsters-joker-2-professional', 'Dragon Quest', ARRAY['Nintendo DS'], 'manual', true, '2011-03-31', 'Square Enix', 'Square Enix', NOW()),
('dq_monsters_joker3', 'Dragon Quest Monsters: Joker 3', 'dragon-quest-monsters-joker-3', 'Dragon Quest', ARRAY['Nintendo 3DS'], 'manual', true, '2016-03-24', 'Square Enix', 'Square Enix', NOW()),
('dq_monsters_joker3_pro', 'Dragon Quest Monsters: Joker 3 Professional', 'dragon-quest-monsters-joker-3-professional', 'Dragon Quest', ARRAY['Nintendo 3DS'], 'manual', true, '2017-02-09', 'Square Enix', 'Square Enix', NOW()),
...
('dq_walk', 'Dragon Quest Walk', 'dragon-quest-walk', 'Dragon Quest', ARRAY['iOS', 'Android'], 'manual', true, '2019-09-12', 'Square Enix', 'Square Enix', NOW()),
...
('dq_of_stars', 'Dragon Quest of the Stars', 'dragon-quest-of-the-stars', 'Dragon Quest', ARRAY['iOS', 'Android'], 'manual', true, '2015-10-15', 'Square Enix', 'Square Enix', NOW()),
('dq_battle_road', 'Dragon Quest: Monster Battle Road', 'dragon-quest-monster-battle-road', 'Dragon Quest', ARRAY['Arcade'], 'manual', true, '2007-06-21', 'Square Enix', 'Square Enix', NOW()),
...
('lego_creator_1998', 'LEGO Creator', 'lego-creator', 'Lego Games', ARRAY['PC'], 'manual', true, '1998-10-01', 'Superscape', 'LEGO Media', NOW()),
('lego_creator_hp', 'LEGO Creator: Harry Potter', 'lego-creator-harry-potter', 'Lego Games', ARRAY['PC'], 'manual', true, '2001-10-30', 'Superscape', 'LEGO Software', NOW()),
('lego_creator_knights', 'LEGO Creator: Knights'' Kingdom', 'lego-creator-knights-kingdom', 'Lego Games', ARRAY['PC'], 'manual', true, '2000-09-15', 'Superscape', 'LEGO Media', NOW()),
...
('lego_friends_heartlake', 'LEGO Friends: Heartlake Rush', 'lego-friends-heartlake-rush', 'Lego Games', ARRAY['iOS', 'Android'], 'manual', true, '2017-09-14', 'TT Games', 'LEGO', NOW()),
...
('lego_minifigures_online', 'LEGO Minifigures Online', 'lego-minifigures-online', 'Lego Games', ARRAY['PC', 'iOS', 'Android'], 'manual', true, '2014-10-29', 'Funcom', 'Funcom', NOW()),
('lego_ninjago_ride', 'LEGO Ninjago: Ride Ninja', 'lego-ninjago-ride-ninja', 'Lego Games', ARRAY['iOS', 'Android'], 'manual', true, '2018-04-05', 'LEGO', 'LEGO', NOW()),
('lego_ninjago_tournament', 'LEGO Ninjago: Tournament', 'lego-ninjago-tournament', 'Lego Games', ARRAY['iOS', 'Android'], 'manual', true, '2015-01-29', 'TT Games', 'Warner Bros.', NOW()),
('lego_soccer_mania', 'LEGO Soccer Mania', 'lego-soccer-mania', 'Lego Games', ARRAY['PC', 'PlayStation 2', 'Game Boy Advance'], 'manual', true, '2002-06-18', 'Silicon Dreams', 'Electronic Arts', NOW()),
('lego_sw_battles', 'LEGO Star Wars Battles', 'lego-star-wars-battles', 'Lego Games', ARRAY['iOS', 'Android'], 'manual', true, '2020-03-20', 'TT Games', 'Warner Bros.', NOW()),
...
('lego_sw_microfighters', 'LEGO Star Wars: Microfighters', 'lego-star-wars-microfighters', 'Lego Games', ARRAY['iOS', 'Android'], 'manual', true, '2014-01-30', 'Warner Bros.', 'Warner Bros.', NOW()),
...
('lego_universe', 'LEGO Universe', 'lego-universe', 'Lego Games', ARRAY['PC'], 'manual', true, '2010-10-26', 'NetDevil', 'LEGO', NOW()),

-- ================================================================
-- MEGAMI TENSEI FRANCHISE (21 missing games)
-- ================================================================
('demikids_light', 'DemiKids Light Version', 'demikids-light-version', 'Megami Tensei', ARRAY['Game Boy Advance'], 'manual', true, '2002-10-07', 'Atlus', 'Atlus', NOW()),
('demikids_dark', 'DemiKids Dark Version', 'demikids-dark-version', 'Megami Tensei', ARRAY['Game Boy Advance'], 'manual', true, '2002-10-07', 'Atlus', 'Atlus', NOW()),
...
('jack_bros', 'Jack Bros.', 'jack-bros', 'Megami Tensei', ARRAY['Virtual Boy'], 'manual', true, '1995-09-29', 'Atlus', 'Atlus', NOW()),
...
('majin_tensei_1', 'Majin Tensei', 'majin-tensei', 'Megami Tensei', ARRAY['Super Nintendo'], 'manual', true, '1994-01-28', 'Atlus', 'Atlus', NOW()),
...
('majin_tensei_blind', 'Majin Tensei: Blind Thinker', 'majin-tensei-blind-thinker', 'Megami Tensei', ARRAY['Mobile'], 'manual', true, '2007-08-20', 'Atlus', 'Atlus', NOW()),
...
('ronde', 'Ronde', 'ronde', 'Megami Tensei', ARRAY['Sega Saturn'], 'manual', true, '1997-10-30', 'Multimedia Intelligence Transfer', 'Atlus', NOW()),
('smt_nine', 'Shin Megami Tensei NINE', 'shin-megami-tensei-nine', 'Megami Tensei', ARRAY['Xbox'], 'manual', true, '2002-12-05', 'Atlus', 'Atlus', NOW()),
...
('smt_devil_summoner_1', 'Shin Megami Tensei: Devil Summoner', 'shin-megami-tensei-devil-summoner', 'Megami Tensei', ARRAY['Sega Saturn', 'PSP'], 'manual', true, '1995-12-25', 'Atlus', 'Atlus', NOW()),
('smt_imagine', 'Shin Megami Tensei: Imagine', 'shin-megami-tensei-imagine', 'Megami Tensei', ARRAY['PC'], 'manual', true, '2007-03-30', 'Cave', 'Atlus', NOW()),
...
-- ================================================================
('tales_asteria', 'Tales of Asteria', 'tales-of-asteria', 'Tales', ARRAY['iOS', 'Android'], 'manual', true, '2014-04-03', 'Bandai Namco', 'Bandai Namco', NOW()),
('tales_crestoria', 'Tales of Crestoria', 'tales-of-crestoria', 'Tales', ARRAY['iOS', 'Android'], 'manual', true, '2020-07-16', 'Bandai Namco', 'Bandai Namco', NOW()),
...
('tales_destiny_dc', 'Tales of Destiny Director''s Cut', 'tales-of-destiny-directors-cut', 'Tales', ARRAY['PlayStation 2'], 'manual', true, '2008-01-31', 'Namco Tales Studio', 'Bandai Namco', NOW()),
...
('tales_innocence_r', 'Tales of Innocence R', 'tales-of-innocence-r', 'Tales', ARRAY['PlayStation Vita'], 'manual', true, '2012-01-26', 'Namco Tales Studio', 'Bandai Namco', NOW()),
('tales_link', 'Tales of Link', 'tales-of-link', 'Tales', ARRAY['iOS', 'Android'], 'manual', true, '2014-03-03', 'Bandai Namco', 'Bandai Namco', NOW()),
...
('tales_phantasia_narikiri', 'Tales of Phantasia: Narikiri Dungeon', 'tales-of-phantasia-narikiri-dungeon', 'Tales', ARRAY['Game Boy Color'], 'manual', true, '2000-11-10', 'Namco', 'Namco', NOW()),
...
('tales_vs', 'Tales of VS.', 'tales-of-vs', 'Tales', ARRAY['PSP'], 'manual', true, '2009-08-06', 'Namco Tales Studio', 'Bandai Namco', NOW()),
('tales_rays', 'Tales of the Rays', 'tales-of-the-rays', 'Tales', ARRAY['iOS', 'Android'], 'manual', true, '2017-02-28', 'Bandai Namco', 'Bandai Namco', NOW()),
...
-- Bioshock
('bioshock_4', 'BioShock 4', 'bioshock-4', 'Bioshock', ARRAY['TBA'], 'manual', true, NULL, 'Cloud Chamber', '2K Games', NOW()),

-- Counter-Strike
('cs_online', 'Counter-Strike Online', 'counter-strike-online', 'Counter Strike', ARRAY['PC'], 'manual', true, '2008-05-01', 'Nexon', 'Nexon', NOW()),
('cs_online_2', 'Counter-Strike Online 2', 'counter-strike-online-2', 'Counter Strike', ARRAY['PC'], 'manual', true, '2013-07-17', 'Nexon', 'Nexon', NOW()),
('cs_neo', 'Counter-Strike Neo', 'counter-strike-neo', 'Counter Strike', ARRAY['Arcade'], 'manual', true, '2003-10-01', 'Namco', 'Namco', NOW()),

-- Crash Bandicoot
('crash_nitro_3d', 'Crash Bandicoot Nitro Kart 3D', 'crash-bandicoot-nitro-kart-3d', 'Crash Bandicoot', ARRAY['iOS'], 'manual', true, '2008-07-09', 'Polarbit', 'Vivendi', NOW()),
...
('far_cry_arena_master', 'Far Cry 4: Arena Master', 'far-cry-4-arena-master', 'Far Cry', ARRAY['iOS', 'Android'], 'manual', true, '2015-01-20', 'Ludomade', 'Ubisoft', NOW()),

-- Gears of War
('gears_pop', 'Gears POP!', 'gears-pop', 'Gears of War', ARRAY['iOS', 'Android'], 'manual', true, '2019-08-22', 'Mediatonic', 'Microsoft', NOW()),
('gears_6', 'Gears 6', 'gears-6', 'Gears of War', ARRAY['TBA'], 'manual', true, NULL, 'The Coalition', 'Xbox Game Studios', NOW()),

-- Halo
('halo_online', 'Halo Online', 'halo-online', 'Halo', ARRAY['PC'], 'manual', true, '2015-03-29', '343 Industries', 'Microsoft', NOW()),
('halo_fireteam_raven', 'Halo: Fireteam Raven', 'halo-fireteam-raven', 'Halo', ARRAY['Arcade'], 'manual', true, '2018-07-10', '343 Industries', 'Raw Thrills', NOW()),

-- Harry Potter
('hp_wizards_unite', 'Harry Potter: Wizards Unite', 'harry-potter-wizards-unite', 'Harry Potter', ARRAY['iOS', 'Android'], 'manual', true, '2019-06-21', 'Niantic', 'Niantic', NOW()),
('hp_magic_awakened', 'Harry Potter: Magic Awakened', 'harry-potter-magic-awakened', 'Harry Potter', ARRAY['iOS', 'Android', 'PC'], 'manual', true, '2021-09-09', 'NetEase', 'NetEase', NOW()),

-- Kingdom Hearts
('kh_dark_road', 'Kingdom Hearts: Dark Road', 'kingdom-hearts-dark-road', 'Kingdom Hearts', ARRAY['iOS', 'Android'], 'manual', true, '2020-06-22', 'Square Enix', 'Square Enix', NOW()),
...
-- Marvel
('marvel_heroes', 'Marvel Heroes', 'marvel-heroes', 'Marvel', ARRAY['PC'], 'manual', true, '2013-06-04', 'Gazillion', 'Gazillion', NOW()),
('marvel_powers_vr', 'Marvel Powers United VR', 'marvel-powers-united-vr', 'Marvel', ARRAY['Oculus Rift'], 'manual', true, '2018-07-26', 'Sanzaru Games', 'Oculus Studios', NOW()),

-- Minecraft
('minecraft_earth', 'Minecraft Earth', 'minecraft-earth', 'Minecraft', ARRAY['iOS', 'Android'], 'manual', true, '2019-10-17', 'Mojang', 'Microsoft', NOW()),
('minecraft_story_mode', 'Minecraft: Story Mode', 'minecraft-story-mode', 'Minecraft', ARRAY['Multi-platform'], 'manual', true, '2015-10-13', 'Telltale Games', 'Telltale Games', NOW()),

-- Need for Speed
('nfs_hp_hd', 'Need for Speed: Hot Pursuit HD', 'need-for-speed-hot-pursuit-hd', 'Need for Speed', ARRAY['Multi-platform'], 'manual', true, '2010-11-16', 'Criterion Games', 'Electronic Arts', NOW()),

-- PUBG
('pubg_lite', 'PUBG Lite', 'pubg-lite', 'PUBG', ARRAY['PC'], 'manual', true, '2019-01-24', 'PUBG Corporation', 'PUBG Corporation', NOW()),

-- Star Wars
('sw_galaxies', 'Star Wars Galaxies', 'star-wars-galaxies', 'Star Wars', ARRAY['PC'], 'manual', true, '2003-06-26', 'Sony Online', 'LucasArts', NOW()),
('sw_commander', 'Star Wars: Commander', 'star-wars-commander', 'Star Wars', ARRAY['iOS', 'Android'], 'manual', true, '2014-08-21', 'Disney', 'Disney', NOW()),

-- Tetris
('tetris_blitz', 'Tetris Blitz', 'tetris-blitz', 'Tetris', ARRAY['iOS', 'Android'], 'manual', true, '2013-05-21', 'Electronic Arts', 'Electronic Arts', NOW()),
...
-- Tomb Raider
('tomb_raider_gold', 'Tomb Raider Gold', 'tomb-raider-gold', 'Tomb Raider', ARRAY['PC', 'Mac'], 'manual', true, '1998-11-25', 'Core Design', 'Eidos', NOW()),

-- Tony Hawk
('tony_hawk_motion', 'Tony Hawk''s Motion', 'tony-hawks-motion', 'Tony Hawk', ARRAY['Nintendo DS'], 'manual', true, '2008-11-18', 'Creat Studios', 'Activision', NOW()),

-- WWE
('wwe_immortals', 'WWE Immortals', 'wwe-immortals', 'WWE', ARRAY['iOS', 'Android'], 'manual', true, '2015-01-15', 'NetherRealm', 'Warner Bros.', NOW()),
...
-- 3. Proceed to Phase 2 for additional missing games
-- ================================================================