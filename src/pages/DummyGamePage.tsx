...
import { Star, Calendar, User, MessageCircle, Plus, Check, Heart, ScrollText, Play, Download, Share2, Bookmark } from 'lucide-react';
  ...
  const dummyReviews = [
    {
      ...
      rating: 9.5,
      text: 'Absolutely phenomenal! The world-building is incredible and the story kept me hooked for weeks. The magic system is innovative and the character progression feels rewarding. This is easily one of the best RPGs I\'ve played in years.',
      date: '2024-01-20',
      hasText: true,
    ...
    },
    {
      ...
      gameId: 'dummy-test-game',
      rating: 8.5,
      text: 'Great game with stunning visuals and solid gameplay mechanics. The co-op mode is a blast to play with friends. Some minor bugs here and there, but nothing game-breaking. Definitely worth the price.',
      date: '2024-01-18',
      hasText: true,
      author: 'RPGMaster',
    ...
    },
    {
      ...
      gameId: 'dummy-test-game',
      rating: 9.0,
      text: 'The attention to detail is remarkable. Every NPC feels alive, every quest has meaning, and the world reacts to your choices in meaningful ways. The soundtrack is also absolutely beautiful.',
      date: '2024-01-15',
      hasText: true,
      author: 'StorySeeker',
    ...
    },
    {
      ...
      gameId: 'dummy-test-game',
      rating: 8.0,
      text: 'Solid RPG with great production values. The combat system takes some getting used to, but once you master it, it\'s very satisfying. Lots of content to keep you busy for months.',
      date: '2024-01-12',
      hasText: true,
      author: 'CasualGamer',
    ...
    },
    {
      ...
      gameId: 'dummy-test-game',
      rating: 9.5,
      text: 'This game exceeded all my expectations. The character customization is deep, the world is vast and beautiful, and the story is emotionally engaging. A true masterpiece.',
      date: '2024-01-10',
      hasText: true,
      author: 'EpicGamer',
    ...
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-purple-600 text-white p-4 rounded-lg mb-6 text-center">
          ...
          <p className="text-sm opacity-90">This is a test page with comprehensive dummy data for development purposes</p>
        </div>
