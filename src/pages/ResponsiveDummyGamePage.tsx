...
import { Star, Calendar, User, MessageCircle, Plus, Check, Heart, ScrollText, Play, Download, Share2, Bookmark, Trophy, Clock, Users as UsersIcon, Gamepad2 } from 'lucide-react';
import { StarRating } from '../components/StarRating';
import { ReviewCard } from '../components/ReviewCard';
import { igdbService } from '../services/igdbApi';
import { useResponsive } from '../hooks/useResponsive';

export const ResponsiveDummyGamePage: React.FC = () => {
  ...
  const recentReviews = dummyReviews.slice(0, isMobile ? 3 : 5);
    ...
    return (
      <div className="min-h-screen bg-gray-900">
        ...
        <div className="bg-green-600 text-white p-4 text-center">
          <h2 className="text-lg font-semibold">🎮 Dummy Test Game Page - Mobile</h2>
          <p className="text-sm opacity-90">Mobile-optimized game page showcasing responsive design</p>
        </div>
        ...
        <div className="bg-gray-800 p-4">
          <div className="flex gap-4 mb-4">
            {loading ? (
              <div className="w-24 h-32 bg-gray-700 animate-pulse rounded flex items-center justify-center">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold text-white mb-2">{dummyGame.title}</h1>
          ...
          <div className="flex gap-2 mb-4">
            <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg text-sm">
              <Play className="h-4 w-4" />
              Play
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`relative w-5 h-5 border-2 border-gray-400 rounded transition-all duration-200 flex items-center justify-center overflow-visible ${
                    isInWishlist 
                ...
                >
                  {isInWishlist && (
                    <Check className="h-6 w-6 text-green-500 stroke-[3] absolute -top-0.5 -left-0.5" />
                  )}
                </button>
                <span className="text-gray-300 text-xs">Started</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 text-xs">Finished</span>
              </div>
            </div>
            
            <Link
              to={`/review/${dummyGame.id}`}
              className="flex items-center gap-2 px-3 py-2 bg-purple-600 text-white rounded-lg text-xs"
            >
        ...
        <div className="p-4 bg-gray-800 border-t border-gray-700">
          ...
          <p className="text-gray-300 text-sm leading-relaxed">{dummyGame.description}</p>
        </div>
        ...
        <div className="p-4 bg-gray-800 border-t border-gray-700">
          ...
          <div className="grid grid-cols-2 gap-2">
            {dummyGame.screenshots.slice(0, 4).map((screenshot, index) => (
              <img
                key={index}
                src={screenshot}
  ...
  // Desktop version (existing design with responsive enhancements)
  return (
    <div className="min-h-screen bg-gray-900 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Dummy Test Banner */}
        <div className="bg-green-600 text-white p-4 rounded-lg mb-6 text-center">
          <h2 className="text-lg font-semibold">🎮 Dummy Test Game Page - Desktop</h2>
