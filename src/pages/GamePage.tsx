    ...
    <>
      ...
      <div className="min-h-screen bg-gray-900 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 lg:mb-12">
          {/* Game Cover and Info */}
          <div className="lg:col-span-2">
            <div className="bg-gradient-to-br from-gray-800/90 to-gray-700/80 rounded-lg overflow-hidden">
              <div className="md:flex">
                <div className="md:flex-shrink-0">
                  <SmartImage
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-gray-800/90 to-gray-700/80 rounded-lg p-6">
            ...
            <div className="space-y-4">
              {reviewsWithText.slice(0, 5).map(review => (
                <Link 
                  ...
                  className="bg-gradient-to-br from-gray-800/90 to-gray-700/80 rounded-lg p-4 block hover:from-slate-800/90 hover:to-slate-700/80 transition-all"
                >
