    ...
    const loadReviews = async () => {
      ...
      try {
        ...
        if (existingGame) {
          ...
          //   cover_url: game.cover?.url || game.coverImage || null,
          ...
          //   genres: game.genres ? JSON.stringify(game.genres.map(g => g.name || g)) : null,
          //   platforms: game.platforms ? JSON.stringify(game.platforms.map(p => p.name || p)) : null
          // };
          //const gameData: CreateGameData = mapIGDBToGameData(game, id);
